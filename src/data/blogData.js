// Blog Data with full article content
export const blogData = [
  {
    id: 1,
    slug: 'bosanma-davalarinda-mal-paylasimi',
    title: "Boşanma Davalarında Mal Paylaşımı Nasıl Yapılır?",
    excerpt: "Edinilmiş mallara katılma rejimi kapsamında boşanma sürecinde malların nasıl paylaşıldığını detaylı inceliyoruz.",
    category: "Aile Hukuku",
    date: "2024-12-01",
    readTime: "5 dk",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=80&w=1200&auto=format&fit=crop",
    content: `
      <h3>Edinilmiş Mallara Katılma Rejimi Nedir?</h3>
      <p>Türk Medeni Kanunu'na göre, evlilik birliği içinde edinilen mallar "edinilmiş mal" olarak kabul edilir. 2002 yılından bu yana yasal mal rejimi olarak kabul edilen edinilmiş mallara katılma rejiminde, her eş evlilik süresince edindiği malların yarısı üzerinde hak sahibidir.</p>
      
      <h3>Hangi Mallar Paylaşıma Dahildir?</h3>
      <p>Evlilik süresince edinilen şu mallar paylaşıma tabidir:</p>
      <ul>
        <li><strong>Çalışma Karşılığı Edinilen Mallar:</strong> Maaş, ücret, ikramiye gibi gelirler</li>
        <li><strong>Sosyal Güvenlik Ödemeleri:</strong> Emekli maaşı, işsizlik maaşı</li>
        <li><strong>Çalışma Gücü Kaybı Tazminatları:</strong> İş kazası tazminatları</li>
        <li><strong>Edinilmiş Malların Gelirleri:</strong> Kira geliri, faiz geliri</li>
        <li><strong>Kişisel Malların Yerine Geçen Değerler:</strong> Satılan kişisel malın yerine alınan mal</li>
      </ul>
      
      <h3>Kişisel Mallar Nelerdir?</h3>
      <p>Aşağıdaki mallar kişisel mal sayılır ve paylaşıma dahil edilmez:</p>
      <ul>
        <li>Evlilik öncesi edinilen mallar</li>
        <li>Miras yoluyla kazanılan mallar</li>
        <li>Karşılıksız kazanmalar (bağış, hediye)</li>
        <li>Manevi tazminat alacakları</li>
        <li>Kişisel kullanıma özgü eşyalar</li>
      </ul>
      
      <h3>Mal Paylaşımı Süreci</h3>
      <p>Boşanma davasında mal paylaşımı şu aşamalardan geçer:</p>
      <ul>
        <li><strong>Malların Tespiti:</strong> Her iki tarafın malları tespit edilir</li>
        <li><strong>Değer Belirleme:</strong> Bilirkişi aracılığıyla malların güncel değeri belirlenir</li>
        <li><strong>Katılma Alacağı Hesabı:</strong> Her eşin katılma alacağı hesaplanır</li>
        <li><strong>Ödeme veya Tasfiye:</strong> Alacak para olarak ödenir veya mal devri yapılır</li>
      </ul>
      
      <h3>Dikkat Edilmesi Gerekenler</h3>
      <p>Mal paylaşımı davalarında dikkat edilmesi gereken önemli hususlar:</p>
      <ul>
        <li>Boşanma kararının kesinleşmesinden itibaren 10 yıllık zamanaşımı süresi vardır</li>
        <li>Evlilik sözleşmesi ile farklı bir mal rejimi seçilebilir</li>
        <li>Katkı payı alacağı ve değer artış payı ayrıca talep edilebilir</li>
        <li>Mal kaçırma durumunda önlem alınabilir</li>
      </ul>
  ...
  },
  {
    ...
    excerpt: "İş kazası sonrası hak edilen tazminat türleri ve hesaplama yöntemleri hakkında bilmeniz gerekenler.",
    category: "İş Hukuku",
    date: "2024-11-28",
    readTime: "7 dk",
    image: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=1200&auto=format&fit=crop",
    content: `
      <h3>İş Kazası Nedir?</h3>
      <p>İş Kazası, 5510 sayılı Sosyal Sigortalar ve Genel Sağlık Sigortası Kanunu'na göre, sigortalının işyerinde bulunduğu sırada, işveren tarafından yürütülen iş nedeniyle veya işveren tarafından görev ile başka bir yere gönderilmesi nedeniyle meydana gelen ve sigortalıyı hemen veya sonradan bedenen ya da ruhen özre uğratan olaydır.</p>
      
      <h3>İş Kazası Tazminat Türleri</h3>
      <p>İş kazası sonrası talep edilebilecek tazminat türleri:</p>
      <ul>
        <li><strong>Maddi Tazminat:</strong> Tedavi giderleri, gelir kaybı, çalışma gücü kaybı</li>
        <li><strong>Manevi Tazminat:</strong> Acı, elem ve ıstırap karşılığı</li>
        <li><strong>Destekten Yoksun Kalma:</strong> Ölüm halinde yakınların tazminatı</li>
        <li><strong>SGK Geçici/Sürekli İş Göremezlik:</strong> Kurum tarafından ödenen tazminat</li>
      </ul>
      
      <h3>Maddi Tazminat Hesaplama</h3>
      <p>Maddi tazminat hesaplamasında dikkate alınan faktörler:</p>
      <ul>
        <li>İşçinin yaşı ve yaşam beklentisi</li>
        <li>Maluliyet oranı (%)</li>
        <li>Son aldığı ücret</li>
        <li>Kusur oranları (işveren, işçi, 3. kişi)</li>
        <li>SGK tarafından bağlanan gelirler</li>
      </ul>
      
      <h3>Manevi Tazminat Kriterleri</h3>
      <p>Manevi tazminat miktarı belirlenirken:</p>
      <ul>
        <li>Kazanın ağırlığı ve sonuçları</li>
        <li>Tarafların ekonomik durumu</li>
        <li>Kusur oranları</li>
        <li>Olayın meydana geliş şekli</li>
        <li>Yaşanan acı ve ıstırabın boyutu</li>
      </ul>
      
      <h3>Zamanaşımı Süreleri</h3>
      <p>İş kazası tazminat davalarında zamanaşımı:</p>
      <ul>
        <li>Maddi-manevi tazminat: Kazadan itibaren 10 yıl</li>
        <li>Suç teşkil eden hallerde: Ceza davası zamanaşımı süresi</li>
        <li>SGK'ya başvuru: 3 iş günü içinde bildirim</li>
      </ul>
      
      <h3>Dava Süreci</h3>
      <p>İş kazası davası sürecinde izlenmesi gereken adımlar:</p>
      <ul>
        <li>İş kazası bildiriminin yapılması</li>
        <li>Sağlık kurulu raporu alınması</li>
        <li>Maluliyet oranının belirlenmesi</li>
        <li>Aktüerya hesabı yapılması</li>
        <li>Dava açılması ve takibi</li>
      </ul>
      
      <h3>Profesyonel Destek</h3>
      <p>İş kazası tazminat davaları teknik bilgi gerektiren karmaşık davalardır. Haklarınızı tam olarak alabilmeniz için deneyimli bir iş hukuku avukatından destek almanız önemlidir.</p>
    `
  },
  {
    id: 3,
    slug: 'kira-sozlesmesi-hazirlama',
    title: "Kira Sözleşmesi Hazırlarken Dikkat Edilmesi Gerekenler",
    excerpt: "Hem kiracı hem de ev sahibi için güvenli bir kira sözleşmesi nasıl hazırlanır?",
    category: "Gayrimenkul Hukuku",
    date: "2024-11-25",
    readTime: "4 dk",
    image: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1200&auto=format&fit=crop",
    content: `
      <h3>Kira Sözleşmesinin Önemi</h3>
      <p>Kira sözleşmesi, kiracı ve kiraya veren arasındaki hukuki ilişkiyi düzenleyen en önemli belgedir. Olası uyuşmazlıkların önlenmesi ve tarafların haklarının korunması için detaylı ve açık bir sözleşme hazırlanması büyük önem taşır.</p>
      
      <h3>Sözleşmede Bulunması Gereken Temel Bilgiler</h3>
      <ul>
        <li><strong>Taraf Bilgileri:</strong> Kiraya veren ve kiracının tam kimlik bilgileri</li>
        <li><strong>Taşınmaz Bilgileri:</strong> Adres, ada, parsel, bağımsız bölüm numarası</li>
        <li><strong>Kira Bedeli:</strong> Aylık kira tutarı ve ödeme günü</li>
        <li><strong>Depozito:</strong> Güvence bedeli tutarı ve iade koşulları</li>
        <li><strong>Kira Süresi:</strong> Başlangıç ve bitiş tarihi</li>
      </ul>
      
      <h3>Kira Artış Oranı</h3>
      <p>2024 yılı itibarıyla konut kiralarında dikkat edilmesi gerekenler:</p>
      <ul>
        <li>Konut kiralarında yıllık artış TÜFE ile sınırlıdır</li>
        <li>Artış oranı sözleşmede belirtilmelidir</li>
        <li>Yasal sınırı aşan artışlar geçersizdir</li>
        <li>İşyeri kiralarında farklı kurallar uygulanabilir</li>
      </ul>
      
      <h3>Kiracının Hakları ve Yükümlülükleri</h3>
      <ul>
        <li>Kiralananı özenle kullanma yükümlülüğü</li>
        <li>Kirayı zamanında ödeme yükümlülüğü</li>
        <li>Olağan bakım giderlerini karşılama</li>
        <li>Tahliye süreleri ve koşulları</li>
        <li>Alt kiraya verme kuralları</li>
      </ul>
      
      <h3>Kiraya Verenin Hakları ve Yükümlülükleri</h3>
      <ul>
        <li>Kiralananı kullanıma elverişli teslim etme</li>
        <li>Esaslı tadilat ve onarımları yapma</li>
        <li>Kiracının özel hayatına saygı gösterme</li>
        <li>Tahliye davası açma koşulları</li>
        <li>Depozito iade yükümlülüğü</li>
      </ul>
      
      <h3>Sık Yapılan Hatalar</h3>
      <ul>
        <li>Sözleşmenin yazılı yapılmaması</li>
        <li>Demirbaşların tespit edilmemesi</li>
        <li>Aidat ve giderlerin belirsiz bırakılması</li>
        <li>Tahliye koşullarının net olmaması</li>
        <li>Depozito iadesinin düzenlenmemesi</li>
      </ul>
